...
#### Task 0. Ready player one
Clone [this repository](https://intranet.hbtn.io/rltoken/977q-2GLiVXxSmeknrLv4Q) containing a maze Unity project. You will build on this project by adding new GameObjects and scripts to create a [playable game](https://intranet.hbtn.io/rltoken/wcK7Cp6UDhG2GEhYGxeZWQ). This project should be pushed to its own repo called 0x02-unity-scripting, not within a subdirectory.
...
* Hint: [Time.deltaTime](https://intranet.hbtn.io/rltoken/CvueNOkPIgzcYgMwJO9_nw)
...
#### Task 6. You've activated my trap card
...
* You may have issues with the lighting preview in Unity when testing and reloading your scene. For more information, watch [Fix Lighting Going Dark in the Unity Editor When Resetting a Scene](https://intranet.hbtn.io/rltoken/BzTlhH_RfGb1Yc6lSYh3DA)